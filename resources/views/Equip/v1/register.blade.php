...
{{ Form::open(['route' => 'services.check','method'=>'POST']) }}
    ...
    <div class="form-group">
      <label for="code">驗證碼</label>
        ...
        {{ Form::text('captcha',  null, ['id'=>'captcha', 'placeholder' => '請輸入左側驗證數碼','class' => 'form-control tt-text', 'requried'=>'required', 'style' => 'maxlength:3']) }}
    ...
    {{ Form::submit('送出', ['id' => 'submit_btn', 'class' => 'btn btn-primary']) }}

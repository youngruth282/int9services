			...
			<div class="bs-example">
					<div class="txt_s_18">
						...
						<div align="center">
                            ...
                            @endif                        
                            <div align="center" id="show_msg" style="display:none;">錯誤!!</div>
                        </div>
...
<script type="text/javascript">
	...
	function checkSel()
    {
		...
		if(chkStr != '') {
            // $('#show_msg').show();
            // var msg = document.getElementsById('show_msg');
            // msg.innerHTML="【錯誤訊息】"+chkStr;
            // document.getElementsById('show_msg').text="【錯誤訊息】"+chkStr;
			ShowContent('show_msg');
			return false;
        }
        // if(chkStr != '') {
    //   $("#alertModal").modal('show');
    //   }else $("#sendModal").modal('show');
    }

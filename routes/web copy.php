...
//20191203
Route::get('booking/{no?}','BookController@register');
Route::get('test/{no?}','BookController@test');
Route::post('datasend','BookController@check')->name('booking.memsend');
Route::get('bookingList','BookController@blist');
Route::get('bookingShow/{id}','BookController@bshow')->name('booking.bookingShow');
Route::post('bsearch', 'BookController@bsearch')->name('booking.bsearch');
Route::get('bsearch', 'BookController@bsearch')->name('booking.bsearch');
// Route::get('test/', function () {
//     return redirect('https://int5.bolcc.tw/itjbos/booking');
// });